...
* [EA SEED's Gigi](https://github.com/electronicarts/gigi/releases/tag/v1.0.0): Uses TinyBVH for WebGPU ray tracing, "..as fast as when using the DXR api in DX12". [Demo](https://electronicarts.github.io/gigi/Demos/tinybvh/index.html).
