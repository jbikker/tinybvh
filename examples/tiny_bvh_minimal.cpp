...
// All triangles are specified as 3 vertices; each vertex is a 'bvhvec4'. 
// A tinybvh::Ray is constructed using an origin and direction.
// A tinybvh::BVH is instantiated and constructed using BVH::Build( .. ). 
