...
void Init()
{
	...
	init = new Kernel( "kernels/wavefront.cl", "SetRenderData" );
	clear = new Kernel( "kernels/wavefront.cl", "Clear" );
	rayGen = new Kernel( "kernels/wavefront.cl", "Generate" );
	extend = new Kernel( "kernels/wavefront.cl", "Extend" );
	shade = new Kernel( "kernels/wavefront.cl", "Shade" );
	updateCounters1 = new Kernel( "kernels/wavefront.cl", "UpdateCounters1" );
	updateCounters2 = new Kernel( "kernels/wavefront.cl", "UpdateCounters2" );
	traceShadows = new Kernel( "kernels/wavefront.cl", "Connect" );
	finalize = new Kernel( "kernels/wavefront.cl", "Finalize" );
